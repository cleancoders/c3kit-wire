...
(defn BACKSPACE? [e] (KEY? BACKSPACE e))
(defn TAB? [e] (KEY? TAB e))
(defn ENTER? [e] (KEY? ENTER e))
(defn SHIFT? [e] (KEY? SHIFT e))
(defn ESC? [e] (KEY? ESC e))
(defn SPACE? [e] (KEY? SPACE e))
(defn LEFT? [e] (KEY? LEFT e))
(defn UP? [e] (KEY? UP e))
(defn RIGHT? [e] (KEY? RIGHT e))
(defn DOWN? [e] (KEY? DOWN e))
(defn DELETE? [e] (KEY? DELETE e))
(defn NUMPAD+? [e] (KEY? NUMPAD+ e))
