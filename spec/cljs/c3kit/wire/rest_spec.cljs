(ns c3kit.wire.rest-spec
  (:require [speclj.core :refer-macros [before tags focus-describe should-not-be-nil should-have-invoked stub redefs-around with-stubs should-not should context describe should-be-nil should-be it should= should-contain should-not-be]]
...
(describe "Rest"
  (with-stubs)
  (before (api/configure! {:rest-prep-fn nil}))
