...
(describe "c3kit.wire.service-worker.core (real browser smoke)"
  (if-not real-context?
    (it "SKIPPED — Request/Response/Headers/URL unavailable in this runtime" (should-not real-context?))

    (do
      (context "cacheable? against real js/Request + js/Response"
      ...
      (context "->fallback against real js/Response"
