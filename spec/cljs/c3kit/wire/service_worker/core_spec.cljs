(ns c3kit.wire.service-worker.core-spec
  (:require-macros [speclj.core :refer [around before context describe it should should= should-be-nil should-not should-contain with]])
  (:require [c3kit.apron.log :as log :refer-macros [capture-logs]]
            [c3kit.wire.js :as wjs]
            [c3kit.wire.service-worker.fake :as fake]
            [c3kit.wire.service-worker.core :as sut]
            [speclj.core]))
...
(describe "c3kit.wire.service-worker.core"
  ...
  (context "fallback + cache-response!"
  ...
  (context "stale-while-revalidate"
