(ns c3kit.wire.mock.manual-worker-spec
  (:require [c3kit.apron.corec :as ccc]
            [c3kit.apron.log :as log]
            [c3kit.wire.mock.manual-worker :as sut]
            [c3kit.wire.spec-helper :as spec-helper]
            [speclj.core :refer-macros [around context describe should-be it should-be-nil should-not-contain should= should<]]))
